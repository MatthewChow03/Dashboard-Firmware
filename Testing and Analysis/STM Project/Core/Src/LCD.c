...
void DisplayScreen(void) {
	...
	switch (current_page) {
		case (1):
			...
			// The for loop and switch statement were used to simplify the line output code
			// As seen in the OutputString() calls, index i is used to iterate through the rows of data
